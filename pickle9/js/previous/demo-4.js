(function() {
        ...
        document.addEventListener("mousedown", function(e) {
         ...
         function getBodyAtMouse() {
            ...
            console.log(selectedBody);
             ...
             if(selectedBody!=null) world.DestroyBody(selectedBody);
            return selectedBody;
         }
         ...
         function getBodyCB(fixture) {
            ...
            }else if(fixture.GetBody().GetUserData()==999998){
                if(fixture.GetShape().TestPoint(fixture.GetBody().GetTransform(), mousePVec)) {
                  selectedBody = fixture.GetBody();
                  //added by me
    ...
    var add = {
        ...
        box: function(options) {
            ...
            //shape.id=shapeId;
            shapes[shape.id] = shape;
            return box2d.addToWorld(shape); //addToWorld deals with boxes and circles
        },
        bigPot: function() {
            ...
            console.log(buoyancyController.density);
            //The water sensor
        ...
        door1: function() {
            ...
            RemovableBody = add.box({x: 13.15, y: 14.7,height: 0.2, width:4.7, isStatic: true, shapeId:999998});

            console.log(RemovableBody);
        ...
        door2: function() {
            add.box({x: 25.32, y: 11.47,height: 7.8, width:0.7, isStatic: true});
