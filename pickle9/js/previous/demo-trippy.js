(function() {
    ...
    var Box2 = function(options) {
        Shape.call(this, options);
        this.width = options.width || Math.random()*2+5.5;
        this.height = options.height || Math.random()*2+0.5;
        ...
        this.draw = function() {
          ...
          ctx.translate(this.x * SCALE, this.y * SCALE);
            //ctx.rotate(this.angle);
            ctx.translate(-(this.x) * SCALE, -(this.y) * SCALE);
          ctx.moveTo(this.x+65.7, this.y+24.6);
          ctx.lineTo(this.x+61.6, this.y+24.6);
          ctx.lineTo(this.x+61.6, this.y+0.0);
          ctx.lineTo(this.x+65.7, this.y+0.0);
          ctx.lineTo(this.x+65.7, this.y+24.6);
          ctx.closePath();
